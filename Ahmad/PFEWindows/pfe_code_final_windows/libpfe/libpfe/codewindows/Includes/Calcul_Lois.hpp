...
public :
	...
	__declspec(dllexport) void calcul_taux_accroissement(Matrice theta, Matrice stades);
	...
	__declspec(dllexport) void  set_constantes_coeffdepot5(double a1, double a2, double a3, double k);
