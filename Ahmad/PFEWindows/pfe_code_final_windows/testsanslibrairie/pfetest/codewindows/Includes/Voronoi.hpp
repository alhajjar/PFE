/** 
 * \file Voronoi.hpp
 * \brief Fichier d'entête de la bibliotheque de la création et de l'utilisation du diagramme de Voronoï
*/
...
/** \class Voronoi
 *  \brief Classe de création et d'utilisation du diagramme de Voronoï
*/
class Voronoi {
public:
	Voronoi();
