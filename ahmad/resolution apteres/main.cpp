...
#include "pseudoinverse.hpp"
 ...
 int main(int argc, char *argv[]){
     ...
     mat= calculmatriceN2N4 ( 200,  tauxaccroissement , coeffdepot2 );

    //MatriceN matr_C = Resolution_apteres(5 , mat_A, mat_C , coeffdepot2, matricen);

     matr_A =Resolution_ailees (10, m_p ,m_eta , coeffdepot1,mat,1);

     //cout<<matr_A.block<1,194>(0,0)<<endl<<"matr_C-----------------------\n";
