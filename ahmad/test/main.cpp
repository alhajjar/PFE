...
#include "../Includes/save_matrice_A.hpp"
...
/***************************************************************************************************/
        Matricedyn theta(m-1,n);
        theta = Matricedyn::Zero(m-1,n);
        Matricedyn mat_A(m-1,n);
	mat_A = Matricedyn::Zero(m-1,n);
	Matricedyn mat_C(m-1,n);
	mat_C = Matricedyn::Zero(m-1,n);
        cs* N1;
        Matricedyn stades(m-1,n); 
	stades = Matricedyn::Zero(m-1,n);
	Matricedyn m_eta(m-1,n);  
	m_eta = Matricedyn::Zero(m-1,n);
        Matricedyn m_p (m-1,n);
	m_p = Matricedyn::Zero(m-1,n);
	Matricedyn coeffenvol(m-1,n);
	coeffenvol = Matricedyn::Zero(m-1,n);
/***************************************************************************************************/
...
if (strt == "oui")
 save_matrice_A( m , n, mat_A);


cout << "Voulez vous enregistrez le resultatde mat_C[default :oui]:";
