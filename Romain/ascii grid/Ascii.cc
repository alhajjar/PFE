 ...
 */
Matrice Lecture(string fichierAscii){
 ...
 */
void Ecriture(int nclos,int nrows,int xllcorner,int yllcorner,int cellsize,int NODATA_value,Matrice mat,std::string fichierAscii){
